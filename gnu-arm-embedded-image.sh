...
buildah run "$CONTAINER" /bin/sh -c 'microdnf install -y arm-none-eabi-binutils-cs arm-none-eabi-gcc-cs arm-none-eabi-gcc-cs-c++ arm-none-eabi-newlib black clang-tools-extra cmake gdb git ninja-build python3 python3-pip python3-wheel python-unversioned-command --nodocs --setopt install_weak_deps=0'
